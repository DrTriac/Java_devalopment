...
public class Main {
        public static void main(String[] args)
        {
            ...
            for (int i = 0; i < pieterAgenda.getAantal(); i++) {
                System.out.println(/* vul aan */);
            }

            // Print alle afspraken van Jan
            System.out.printf("%n%s heeft %d afspraken:%n", janAgenda.getNaam(), janAgenda.getAantal());
            for (int i = 0; i < janAgenda.getAantal(); i++) {
                System.out.println(/* vul aan */);
            }

            // Print het totaal aantal afspraken
            System.out.printf("%nIn totaal zijn er %d afspraken.", janAgenda.getAantal()+pieterAgenda.getAantal());
        }
